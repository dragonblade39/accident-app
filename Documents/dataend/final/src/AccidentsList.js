...
import "./AccidentsList.css"; // Import the stylesheet for styling

function AccidentsList({ dataUrl }) {
            ...
            {data.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 bg-white text-red-800 hover:bg-red-800 hover:text-white px-4 py-2 rounded-full duration-300 my-2 mx-2"
                >
                  Delete
                </button>
              </div>
